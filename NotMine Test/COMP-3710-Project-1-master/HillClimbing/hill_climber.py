...
class HillClimber:
    ...
    def climb_hill(self):
        ...
        for attempt in range(0, self.attempts):
            ...
            if self.debug:
                string = 'Attempt ' + str(attempt + 1) + ' of ' + str(self.attempts) + '\t|Starting LUT: ' + starting_lut
                file.write(string + '\n')
                print(string)
            ...
            while keep_climbing:
                ...
                for i in range(-1, len(starting_lut)):
                    ...
                    if member_lut in self.previous_luts:
                        if self.debug:
                            string = 'Attempt ' + str(attempt + 1) + ' of ' + str(self.attempts) + ' member ' + str( i + 2) + ' of ' + str(len(starting_lut) + 1) + '\t| LUT: ' + member_lut + ' already tested.'
                            print(string)
                            file.write(string + '\n')
                        continue
                    ...
                    if self.debug:
                        string = 'Attempt ' + str(attempt + 1) + ' of ' + str(self.attempts) + ' member ' + str(i + 2) + ' of ' + str(len(starting_lut) + 1) + '\t| LUT: ' + member_lut
                        file.write(string + '\n')
                        print(string)
                    ...
                    for opponent in range(0, 5):
                        ...
                        if self.debug:
                            string = 'Attempt ' + str(attempt + 1) + ' of ' + str(self.attempts) + ' member ' + str(i + 2) + ' of ' + str(len(starting_lut) + 1) + '\t| ' + strategy + '\t| Score: ' + str(hill_climber.fitness) + '\t| Cumulative Score: ' + str(score)
                            file.write(string + '\n')
                            print(string)
                    ...
                    score /= 5
                    if self.debug:
                        string = 'Attempt ' + str(attempt + 1) + ' of ' + str(self.attempts) + ' member ' + str(i + 2) + ' of ' + str(len(starting_lut) + 1) + '\t| Average Score: ' + str(score)
                        file.write(string + '\n')
                        print(string)
                    ...
                    if score > attempt_score:
                        ...
                        if self.debug:
                            string = 'Attempt ' + str(attempt + 1) + ' of ' + str(self.attempts) + ' member ' + str(i + 2) + ' of ' + str(len(starting_lut) + 1) + '\t| Score ' + str(score) + ' > Best Attempt Score'
                            file.write(string + '\n')
                            print(string)
                    ...
                    # keep climbing.
                        ...
                        if side_steps < self.n_steps:
                            keep_climbing = True
                        if self.debug:
                            string = 'Attempt ' + str(attempt + 1) + ' of ' + str(self.attempts) + ' member ' + str(i + 2) + ' of ' + str(len(starting_lut) + 1) + '\t| Score ' + str(score) + ' == Best Attempt Score ' + str(attempt_score)
                            file.write(string + '\n')
                            print(string)
                    ...
                    if self.top_player is None or score > self.top_player.fitness:
                        ...
                        if self.debug:
                            string = 'Attempt ' + str(attempt + 1) + ' of ' + str(self.attempts) + ' member ' + str(i + 2) + ' of ' + str(len(starting_lut) + 1) + '\t| Best Overall Score: ' + str(score)
                            file.write(string + '\n')
                            print(string)
                    elif self.debug:
                        string = 'Attempt ' + str(attempt + 1) + ' of ' + str(self.attempts) + ' member ' + str(i + 2) + ' of ' + str(len(starting_lut) + 1) + '\t| Score ' + str(score) + ' <= Best Overall Score ' + str(self.top_player.fitness)
                        print(string)
                        file.write(string)
