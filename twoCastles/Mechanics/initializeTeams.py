...
def make__Castle(window):
    red_team_bounds = boundsMechanics.Bounds(
        (
            0,
            0,
            200,
    ...
    blue_team_bounds = boundsMechanics.Bounds(
        (
            settings['window']['screen']['width'] - 200,
            0,
            settings['window']['screen']['width'],
            settings['window']['screen']['height']
        )
    )
    castles = {'red': castleClass.Castle(
        pygame.image.load('Images/castles/red_castle.png'),
        window,
        (
            10,
        ...
        'blue': castleClass.Castle(
        pygame.image.load('Images/castles/blue_castle.png'),
        window,
        (
