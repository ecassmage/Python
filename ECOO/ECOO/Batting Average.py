...
dataList = []
y = 0
with open("E:\\sluggers\\Input\\DATA11.txt", "r") as theFile:
...
def OnButtonClick(button_id):
    ...
    print('====================')
    with open("E:\\sluggers\\Output\\DATA12.txt", 'w') as aFile:
        t = len(team)
        aFile.write('2011 Regular Season\n')
        aFile.write('====================\n')
        for x in range(0, t):
        ...
        aFile.write('Big 10 Av: %s %s' % (t_baa, t_saa))
